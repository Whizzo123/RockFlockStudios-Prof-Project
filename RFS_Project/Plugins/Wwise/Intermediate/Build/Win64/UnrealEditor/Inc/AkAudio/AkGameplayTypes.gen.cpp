...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkSegmentInfo>()
{
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_AkAudio_OnAkBankCallback__DelegateSignature_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_AkAudio_eventOnAkBankCallback_Parms, Result), Z_Construct_UEnum_AkAudio_EAkResult, METADATA_PARAMS(nullptr, 0) }; // 4199047131
...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkExternalSourceInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::ScriptStructInfo[] = {
		{ FAkChannelMask::StaticStruct, Z_Construct_UScriptStruct_FAkChannelMask_Statics::NewStructOps, TEXT("AkChannelMask"), &Z_Registration_Info_UScriptStruct_AkChannelMask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAkChannelMask), 2516024755U) },
		{ FAkOutputSettings::StaticStruct, Z_Construct_UScriptStruct_FAkOutputSettings_Statics::NewStructOps, TEXT("AkOutputSettings"), &Z_Registration_Info_UScriptStruct_AkOutputSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAkOutputSettings), 2437938904U) },
		...
		{ FAkExternalSourceInfo::StaticStruct, Z_Construct_UScriptStruct_FAkExternalSourceInfo_Statics::NewStructOps, TEXT("AkExternalSourceInfo"), &Z_Registration_Info_UScriptStruct_AkExternalSourceInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAkExternalSourceInfo), 223153381U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAkCallbackInfo, UAkCallbackInfo::StaticClass, TEXT("UAkCallbackInfo"), &Z_Registration_Info_UClass_UAkCallbackInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkCallbackInfo), 2024875356U) },
		{ Z_Construct_UClass_UAkEventCallbackInfo, UAkEventCallbackInfo::StaticClass, TEXT("UAkEventCallbackInfo"), &Z_Registration_Info_UClass_UAkEventCallbackInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkEventCallbackInfo), 213625648U) },
		{ Z_Construct_UClass_UAkMIDIEventCallbackInfo, UAkMIDIEventCallbackInfo::StaticClass, TEXT("UAkMIDIEventCallbackInfo"), &Z_Registration_Info_UClass_UAkMIDIEventCallbackInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkMIDIEventCallbackInfo), 4097996567U) },
		{ Z_Construct_UClass_UAkMarkerCallbackInfo, UAkMarkerCallbackInfo::StaticClass, TEXT("UAkMarkerCallbackInfo"), &Z_Registration_Info_UClass_UAkMarkerCallbackInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkMarkerCallbackInfo), 3788610118U) },
		{ Z_Construct_UClass_UAkDurationCallbackInfo, UAkDurationCallbackInfo::StaticClass, TEXT("UAkDurationCallbackInfo"), &Z_Registration_Info_UClass_UAkDurationCallbackInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkDurationCallbackInfo), 2396180398U) },
		{ Z_Construct_UClass_UAkMusicSyncCallbackInfo, UAkMusicSyncCallbackInfo::StaticClass, TEXT("UAkMusicSyncCallbackInfo"), &Z_Registration_Info_UClass_UAkMusicSyncCallbackInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkMusicSyncCallbackInfo), 4205450677U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_1446458070(TEXT("/Script/AkAudio"),
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_AkGameplayTypes_h_Statics::EnumInfo));
