...
template<> WWISERESOURCELOADER_API UScriptStruct* StaticStruct<FWwiseLanguageId>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewProp_LanguageId = { "LanguageId", nullptr, (EPropertyFlags)0x0010000000020815, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWwiseLanguageId, LanguageId), METADATA_PARAMS(Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewProp_LanguageId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewProp_LanguageId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewProp_LanguageName = { "LanguageName", nullptr, (EPropertyFlags)0x0010000000020815, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWwiseLanguageId, LanguageName), METADATA_PARAMS(Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewProp_LanguageName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewProp_LanguageName_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseLanguageId_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseLanguageId_h_Statics::ScriptStructInfo[] = {
		{ FWwiseLanguageId::StaticStruct, Z_Construct_UScriptStruct_FWwiseLanguageId_Statics::NewStructOps, TEXT("WwiseLanguageId"), &Z_Registration_Info_UScriptStruct_WwiseLanguageId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWwiseLanguageId), 1055685165U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseLanguageId_h_222736223(TEXT("/Script/WwiseResourceLoader"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseLanguageId_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_WwiseResourceLoader_Public_Wwise_WwiseLanguageId_h_Statics::ScriptStructInfo),
		nullptr, 0);
