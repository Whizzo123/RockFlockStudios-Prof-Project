...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_ActorFactoryAkAmbientSound_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_ActorFactoryAkAmbientSound_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorFactoryAkAmbientSound, UActorFactoryAkAmbientSound::StaticClass, TEXT("UActorFactoryAkAmbientSound"), &Z_Registration_Info_UClass_UActorFactoryAkAmbientSound, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorFactoryAkAmbientSound), 3875184660U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_ActorFactoryAkAmbientSound_h_476969136(TEXT("/Script/AudiokineticTools"),
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_ActorFactoryAkAmbientSound_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_ActorFactoryAkAmbientSound_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
