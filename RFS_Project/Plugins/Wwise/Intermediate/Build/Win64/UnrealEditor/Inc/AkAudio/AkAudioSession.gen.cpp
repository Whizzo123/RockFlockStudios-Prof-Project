...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkAudioSession>()
{
	...
	struct Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::ScriptStructInfo[] = {
		{ FAkAudioSession::StaticStruct, Z_Construct_UScriptStruct_FAkAudioSession_Statics::NewStructOps, TEXT("AkAudioSession"), &Z_Registration_Info_UScriptStruct_AkAudioSession, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAkAudioSession), 2017235459U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_2929528185(TEXT("/Script/AkAudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_Statics::EnumInfo));
