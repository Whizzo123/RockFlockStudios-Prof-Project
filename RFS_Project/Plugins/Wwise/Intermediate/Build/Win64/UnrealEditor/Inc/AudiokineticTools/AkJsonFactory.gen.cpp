...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_AkJsonFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_AkJsonFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAkJsonFactory, UAkJsonFactory::StaticClass, TEXT("UAkJsonFactory"), &Z_Registration_Info_UClass_UAkJsonFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkJsonFactory), 4006471674U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_AkJsonFactory_h_565193127(TEXT("/Script/AudiokineticTools"),
		Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_AkJsonFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RFS_Project_Plugins_Wwise_Source_AudiokineticTools_Classes_Factories_AkJsonFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
