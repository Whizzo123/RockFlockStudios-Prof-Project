...
private:
	static AK::IAkGlobalPluginContext* Context;
	static const TCHAR* CallbackName;
	static AK::IAkGlobalPluginContext* MonitorContext;
	static const TCHAR* MonitorCallbackName;
